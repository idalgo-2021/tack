...
**Tack** — приложение для создания и управления заметками с поддержкой мультимедиа, геотегов и экспорта. Это Proof of Concept (PoC) приложение, разработанное с целью изучения современных технологий мобильной разработки.
