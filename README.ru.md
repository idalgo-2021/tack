...
**Tack** *(читается как "Тэк")* — локально приложение для создания и управления заметками с поддержкой мультимедиа, геотегов и экспорта. Приложение разработано с целью изучения современных технологий vibe-кодинга в мобильной разработке.
